...
<body style="background: white;"> <!-- Set background to white -->
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4" style="width: 500px; height: 500px; background:#E6E6FA">
            ...
            <form action="<?php echo e(route('valids')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\LENOVO\Documents\kuliah\Semester 3\Toko Bunga\tokobunga\resources\views/admin/login.blade.php ENDPATH**/ ?>