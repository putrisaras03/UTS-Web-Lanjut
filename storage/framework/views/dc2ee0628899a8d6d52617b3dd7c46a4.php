...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('prod')); ?>">Produk</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('log')); ?>">Admin</a></li>
            </ul>
        </div>
    </nav>
...
<?php /**PATH C:\Users\LENOVO\Documents\kuliah\Semester 3\Toko Bunga\tokobunga\resources\views/home.blade.php ENDPATH**/ ?>